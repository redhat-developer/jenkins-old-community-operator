...
type JenkinsSpec struct {
	...
	// The hostname for the route and the Ingress. If this field is empty and we are on
	// OpenShift, a Route is created letting the host to be generated by Route controller.
	// If we are on vanilla k8s and until Ingress v2 is not specified, the Ingress will not be
	// created.
